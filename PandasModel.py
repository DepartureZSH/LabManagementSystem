...
class pandasModel(QAbstractTableModel):
    ...
    def __init__(self):
        ...
        self.path = Path
        self.df1 = pd.read_excel(self.path+"实验室人员.xlsx", header=0)
        self.df2 = pd.read_excel(self.path+"实验室安排.xlsx", header=0)
        self.df3 = pd.read_excel(self.path+"实验室.xlsx", header=0)
        self.AdvancedUpdate()
        self.dataUpdate()
